...
class AMCFund(BaseModel):
    ...
    risk_factor = models.CharField(null=True, blank=True, max_length=30)
    ...
    class Meta:
        ...
        # indexes = [
        #     models.Index(fields=['AMC', ], name='AMCFund_amc_id_idx'),
        #     models.Index(fields=['name', ], name=f'AMCFund_name_idx'),
        #     models.Index(fields=['is_being_sold', ], name=f'AMCFund_is_being_sold_idx'),
        #     models.Index(fields=['fund_class', ], name=f'AMCFund_fund_class_idx'),
        #     models.Index(fields=['fund_type', ], name=f'AMCFund_fund_type_idx'),
        #     models.Index(fields=['fund_sub_type', ], name=f'AMCFund_fund_sub_type_idx'),
        #     models.Index(fields=['fund_type_id', ], name=f'AMCFund_fund_type_id_idx'),
        #     models.Index(fields=['fund_category', ], name=f'AMCFund_fund_category_idx'),
        #     models.Index(fields=['rta_fund_code', ], name=f'AMCFund_rta_fund_code_idx')
        # ]
        pass
    def __str__(self):
            """This defines how the :model:`kbapp.AMCFund` object will be represented."""
...
class AMCFundScheme(BaseModel):
    ...
    Plan_Type = (('DIR', 'Direct Plan'), ('REG', 'Regular Plan'), ('RET', 'Retail Plan'),
                 ('INST', 'Institutional Plan'), ('SINST', 'Super Institutional Plan'))
    Plan_Opt = (('GR', 'Growth'), ('DIV', 'Dividend'), ('BO', 'Bonus'), ('DDIV', 'Daily Dividend'),
                ('WDIV', 'Weekly Dividend'), ('MDIV', 'Monthly Dividend'), ('FDIV', 'Fortnightly Dividend'),
                ('QDIV', 'Querterly Dividend'), ('HDIV', 'Half Yearly Dividend'), ('ADIV', 'Annual Dividend'))
 
    Div_Opt = (('PAYOUT', 'Dividend Payout Option'), ('REINV', 'Dividend Reinvestment Option'),
